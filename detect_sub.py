...
def detect(save_img=False):
    ...
    ##depth of picture in inference file
    depth_filename = os.path.join('inference/images','1.jpg') 
    imgOri = cv2.imread(depth_filename, -1)
    depth_arr=cv2.split(imgOri)[0] 
    img_arr=cv2.split(imgOri)[1:]
    #print(depth_arr)
